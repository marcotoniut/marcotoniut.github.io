    ...
    <div css={docCss}>
      ...
      <main>
        ...
        <article>
          ...
          <p>
            I’ve been positions of leadership, mentoring and negotiation, having
            to coordinate dev teams, pushing for the adoption of modern
            techniques, tools and good practices.
          </p>
          <p>
            Very detail oriented, experimental, code attentive, but aware that
            deadlines and milestones are paramount; try my best at keeping
          ...
          <p>
            ...
            insurance company that's been a major success in Italy. Language
            stack is mainly comprised of Typescript, Elixir, Rust and Elm.`}
          </p>
          <p>
          ...
          <p>
            ...
            system that smartly controls charge/discharge rates of batteries/EVs
            across several countries, mainly the UK and Japan.
          </p>
          <p>
            Full-Stack development • Maintaining the monorepo stack • Mentoring
            developers on TS and React • Developing new systems
          </p>
          <ul css={highlightsCss}>
          ...
          <div>
            Realise the Full-Stack architecture for Propago’s financial system.
            Lead and train staff in then new technology React. Back End was
            developed using C#/SQL Server, deployed to Azure.
          </div>
          <ul css={highlightsCss}>
      ...
      >
        ...
        <ul css={skillsListCss}>
          ...
          <li>Recruiting</li>
          <li>Negotiating with clients</li>
        </ul>
